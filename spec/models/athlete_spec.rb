...
RSpec.describe Athlete, type: :model do
  ...
  describe 'class methods' do
    ...
    it 'average_age' do
      ...
      athlete3 = Athlete.create!(name: 'Fozzy', age: 22, sex: 'F', height: 55, weight: 25, team: 'USA')
      athlete4 = Athlete.create!(name: 'Gonzo', age: 20, sex: 'F', height: 33, weight: 9, team: 'USA')
      athlete5 = Athlete.create!(name: 'Animal', age: 23, sex: 'M', height: 33, weight: 19, team: 'USA')
      athlete6 = Athlete.create!(name: 'Beaker', age: 27, sex: 'M', height: 33, weight: 16, team: 'USA')
      athlete7 = Athlete.create!(name: 'Scooter', age: 26, sex: 'F', height: 33, weight: 0, team: 'USA')
      athlete8 = Athlete.create!(name: 'Gonzo', age: 20, sex: 'F', height: 33, weight: 9, team: 'USA')

      results = Athlete.average_age
      expect(results).to eq(23.4)
    end
  end
end
